<template>
  <div
    ...
    <span v-if="item.data.type === 'update_currency'">
      updated the group
      <span class="font-medium">{{ groupName }}</span>'s currency from <span class="font-medium">{{ item.data.prev
      }}</span> to
    ...
    <span v-if="item.data.type === 'update_name'">
      updated the group
      <span class="font-medium">{{ groupName }}</span>'s name from <span class="font-medium">{{ item.data.prev }}</span>
      to
      <span class="font-medium">{{ item.data.cur }}</span>.
    </span>
